...
Status: V0.1 implementation closure / V0.2 M4 engineering complete, public RC externally gated  
...
- Target release: Web v0.1 (closure) / Desktop v0.2 (M4 engineering complete, public RC gated)
...
- Quality Assurance: Vitest 119/119, Rust 8/8, Playwright cross-browser 48/48, card visual 3/3, desktop visual 5/5, and visual handover 2/2 pass
