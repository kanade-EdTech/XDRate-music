...
1. Close current 0.3.3 Toy and MiniTool interaction issues with traceable packages.
...
3. Create `codex/v0.5.0-game-rating` and validate a minimal game domain pack.
